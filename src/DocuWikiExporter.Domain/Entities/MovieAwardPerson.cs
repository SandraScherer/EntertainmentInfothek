...
/// <summary>EF-Core-Entity für die unveränderte SQLite-Tabelle "Movie_Award_Person".</summary>
public class MovieAwardPerson : EntityBase
{
    ...
    /// <summary>Navigation zur referenzierten Tabelle "Movie_Award" (FK Movie_AwardID).</summary>
