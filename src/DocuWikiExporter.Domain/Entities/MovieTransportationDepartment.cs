...
/// <summary>EF-Core-Entity für die unveränderte SQLite-Tabelle "Movie_TransportationDepartment".</summary>
public class MovieTransportationDepartment : EntityBase
{
