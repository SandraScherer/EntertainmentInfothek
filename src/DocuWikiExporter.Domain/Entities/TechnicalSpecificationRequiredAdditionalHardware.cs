...
/// <summary>EF-Core-Entity für die bestehende SQLite-Tabelle "TechnicalSpecification_RequiredAdditionalHardware".</summary>
public class TechnicalSpecificationRequiredAdditionalHardware : EntityBase
{
