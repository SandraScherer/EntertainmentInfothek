...
/// <summary>EF-Core-Entity für die unveränderte SQLite-Tabelle "Episode_TransportationDepartment".</summary>
public class EpisodeTransportationDepartment : EntityBase
{
