...
/// <summary>EF-Core-Entity für die bestehende SQLite-Tabelle "TechnicalSpecification_RequiredInputDevice".</summary>
public class TechnicalSpecificationRequiredInputDevice : EntityBase
{
