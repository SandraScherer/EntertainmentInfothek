...
/// <summary>EF-Core-Entity für die unveränderte SQLite-Tabelle "Series_TransportationDepartment".</summary>
public class SeriesTransportationDepartment : EntityBase
{
