...
namespace EntertainmentDB.Data
{
    ...
    public class SoundMixItem : EntryItem
    {
        ...
        public SoundMixItem(string id, string targetTableName = "SoundMix")
        {
            if (id == null)
            {
        ...
        public override int RetrieveBasicInformation()
        {
            ...
            if (1 == Reader.Retrieve())
            {
                ...
                if (!String.IsNullOrEmpty(row["SoundMixID"].ToString()))
                {
                    ...
                    SoundMix.RetrieveBasicInformation();
                }
        ...
        public static List<SoundMixItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName = "SoundMix", string order = "ID")
        {
            if (reader == null)
            {
