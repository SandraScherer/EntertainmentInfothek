...
namespace EntertainmentDB.Data
{
    ...
    public class NegativeFormatItem : EntryItem
    {
        ...
        public NegativeFormatItem(string id, string targetTableName) : base(id, targetTableName)
        {
            if (id == null)
            {
        ...
        /// <summary>
        /// Retrieves the additional information of the negative format item from the database (none available).
        /// </summary>
        /// <returns>0</returns>
