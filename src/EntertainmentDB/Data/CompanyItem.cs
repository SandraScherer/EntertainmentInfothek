...
namespace EntertainmentDB.Data
{
    ...
    public class CompanyItem : EntryItem
    {
        ...
        public CompanyItem(string id, string targetTableName) : base(id, targetTableName)
        {
            if (id == null)
            {
            ...
            Logger.Trace($"CompanyItem() angelegt");
        }
        ...
        /// <summary>
        /// Retrieves the additional information of the company item from the database (none available).
        /// </summary>
        /// <returns>0</returns>
