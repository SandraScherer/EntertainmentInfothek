...
namespace EntertainmentDB.Data
{
    ...
    public class FilmFormat : Entry
    {
        ...
        public FilmFormat(DBReader reader, string id) : base(reader, id)
        {
            ...
            Logger.Trace($"FilmFormat(): FilmFormat with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"FilmFormat.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"FilmFormat.StatusID is not null -> retrieve");
