...
namespace EntertainmentDB.Data
{
    ...
    public class AspectRatioItem : EntryItem
    {
        ...
        public AspectRatioItem(string id, string targetTableName = "AspectRatio")
        {
            if (id == null)
            {
            ...
            Logger.Trace($"AspectRatioItem() angelegt");
        ...
        public override int RetrieveBasicInformation()
        {
            ...
            if (1 == Reader.Retrieve())
            {
                ...
                if (!String.IsNullOrEmpty(row["AspectRatioID"].ToString()))
                {
                    ...
                    AspectRatio.RetrieveBasicInformation();
                }
        ...
        /// <summary>
        /// Retrieves the additional information of the aspect ratio item from the database (none available).
        /// </summary>
        /// <returns>0</returns>
        ...
        public static List<AspectRatioItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName = "AspectRatio", string order = "ID")
        {
            if (reader == null)
            {
