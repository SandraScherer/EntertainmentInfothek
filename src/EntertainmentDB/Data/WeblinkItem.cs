...
namespace EntertainmentDB.Data
{
    ...
    public class WeblinkItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a weblink item with the given reader and empty id string and table names.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a weblink item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the weblink item information from the database.</param>
