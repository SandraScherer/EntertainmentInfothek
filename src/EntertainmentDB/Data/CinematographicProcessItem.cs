...
namespace EntertainmentDB.Data
{
    ...
    public class CinematographicProcessItem : EntryItem
    {
        ...
        {
            Logger.Trace($"CinematographicProcessItem()");
        ...
        protected override int RetrieveBasicInformation(bool retrieveBasicInfoOnly)
        {
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Info($"CinematographicProcessItem.CinematographicProcessID is not null -> retrieve");
                ...
                {
                    Logger.Info($"CinematographicProcessItem.StatusID is not null -> retrieve");
