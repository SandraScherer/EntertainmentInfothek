...
{
    /// <summary>
    /// Provides an image item.
    /// </summary>
    public class ImageItem : EntryItem
    {
        // --- Properties ---

        /// <summary>
        /// The image of the image item.
        /// </summary>
        ...
        /// <summary>
        /// Initializes an image item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the image item information from the database.</param>
        /// <param name="id">The id of the image item.</param>
        /// <param name="baseTableName">The base table name of the image item.</param>
        /// <param name="targetTableName">The target table name of the image item.</param>
        ...
        /// <summary>
        /// Retrieves the basic information of the image item from the database.
        /// </summary>
        /// <param name="retrieveBasicInfoOnly">true if only the basic info is to be retrieved; false if also additional data is to be retrieved.</param>
        /// <returns>1 if data record was retrieved; 0 if no data record matched the id.</returns>
        protected override int RetrieveBasicInformation(bool retrieveBasicInfoOnly)
        {
            Logger.Trace($"ImageItem.RetrieveBasicInformation()");

            Reader.Query = $"SELECT ID, ImageID, Details, StatusID, LastUpdated " +
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"ImageItem.ImageID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"ImageItem.StatusID is not null -> retrieve");
        ...
        /// <summary>
        /// Retrieves a list of image items from the database.
        /// </summary>
        /// <param name="reader">The reader to be used to retrieve the data records.</param>
        /// <param name="baseTableName">The base table name of the image item.</param>
        /// <param name="baseTableID">The base table id of the image item.</param>
        /// <param name="targetTableName">The target table name of the image item.</param>
        /// <param name="order">The order in which the data records are to be sorted.</param>
        /// <returns>The list of image items.</returns>
        /// <exception cref="ArgumentNullException">Thrown when any of the given parameters is null.</exception>
        public static List<ImageItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName, string order = "ID")
        {
            Logger.Trace($"ImageItem.RetrieveList()");
            ...
            if (noOfDataRecords > 0)
            {
                ...
                {
                    ImageItem item = new ImageItem(reader.New());
