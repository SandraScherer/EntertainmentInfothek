...
namespace EntertainmentDB.Data
{
    ...
    public class PrintedFilmFormatItem : EntryItem
    {
        ...
        {
            Logger.Trace($"PrintedFilmFormatItem()");
            ...
            Logger.Trace($"PrintedFilmFormatItem(): PrintedFilmFormatItem with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"PrintedFilmFormatItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"PrintedFilmFormatItem.FilmFormatID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"PrintedFilmFormatItem.StatusID is not null -> retrieve");
        ...
        {
            Logger.Trace($"PrintedFilmFormatItem.RetrieveList()");
