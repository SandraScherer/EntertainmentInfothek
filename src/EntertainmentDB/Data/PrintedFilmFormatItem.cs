...
namespace EntertainmentDB.Data
{
    ...
    public class PrintedFilmFormatItem : EntryItem
    {
        ...
        /// </summary>
        public PrintedFilmFormatItem() : this("")
        {
        }
        ...
        public PrintedFilmFormatItem(string id, string targetTableName = "PrintedFilmFormat")
        {
            if (id == null)
            {
        ...
        public override int RetrieveBasicInformation()
        {
            ...
            if (1 == Reader.Retrieve())
            {
                ...
                {
                    FilmFormat = new FilmFormat();
                    FilmFormat.ID = row["FilmFormatID"].ToString();
                    FilmFormat.RetrieveBasicInformation();
                }
        ...
        public static List<PrintedFilmFormatItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName = "PrintedFilmFormat", string order = "ID")
        {
            if (reader == null)
            {
            ...
            if (reader.Retrieve() > 0)
            {
                ...
                {
                    PrintedFilmFormatItem item = new PrintedFilmFormatItem();
