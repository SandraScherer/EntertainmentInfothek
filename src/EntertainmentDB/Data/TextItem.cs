...
namespace EntertainmentDB.Data
{
    ...
    public class TextItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a text item with the given reader and empty id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the text item information from the database.</param>
        public TextItem(DBReader reader) : this(reader, "", "", "")
        {
        }

        /// <summary>
        /// Initializes a text item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the text item information from the database.</param>
        ...
        /// <returns>The list of text items.</returns>
        /// <exception cref="ArgumentNullException">Thrown when any of the given parameters is null.</exception>
        public static List<TextItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName, string order = "ID")
        {
            ...
            if (noOfDataRecords > 0)
            {
                ...
                {
                    TextItem item = new TextItem(reader.New());
