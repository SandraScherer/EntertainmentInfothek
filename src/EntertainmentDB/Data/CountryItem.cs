...
namespace EntertainmentDB.Data
{
    ...
    public class CountryItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a country item with the given reader and empty id string and table names.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a country item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the country item information from the database.</param>
        ...
        {
            Logger.Trace($"CountryItem(): CountryItem with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"CountryItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"CountryItem.CountryID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"CountryItem.StatusID is not null -> retrieve");
        ...
        {
            Logger.Trace($"CountryItem.RetrieveList()");
