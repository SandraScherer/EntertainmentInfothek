...
namespace EntertainmentDB.Data
{
    ...
    public class DistributorCompanyItem : CompanyItem
    {
        ...
        {
            Logger.Trace($"DistributorCompanyItem()");
        ...
        protected override int RetrieveBasicInformation(bool retrieveBasicInfoOnly)
        {
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Info($"DistributorCompanyItem.CompanyID is not null -> retrieve");
                ...
                {
                    Logger.Info($"DistributorCompanyItem.CountryID is not null -> retrieve");
                ...
                {
                    Logger.Info($"DistributorCompanyItem.StatusID is not null -> retrieve");
