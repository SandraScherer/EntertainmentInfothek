...
namespace EntertainmentDB.Data
{
    ...
    public class GenreItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a genre item with the given reader and empty id string and table names.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a genre item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the genre item information from the database.</param>
        ...
        {
            Logger.Trace($"GenreItem(): GenreItem with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"GenreItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"GenreItem.GenreID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"GenreItem.StatusID is not null -> retrieve");
        ...
        {
            Logger.Trace($"GenreItem.RetrieveList()");
