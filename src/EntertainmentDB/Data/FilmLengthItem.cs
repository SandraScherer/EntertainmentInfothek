...
{
    /// <summary>
    /// Provides a film legth item.
    /// </summary>
    public class FilmLengthItem : EntryItem
    {
        // --- Properties ---

        /// <summary>
        /// The length of the film length item.
        /// </summary>
        ...
        /// <param name="baseTableName">The base table name of the film length item.</param>
        /// <param name="targetTableName">The target table name of the film length item.</param>
        /// <exception cref="ArgumentNullException">Thrown when any of the given parameters is null.</exception>
        public FilmLengthItem(DBReader reader, string id, string baseTableName, string targetTableName) : base(reader, id, baseTableName, targetTableName)
        {
            Logger.Trace($"FilmLengthItem()");
            ...
            Logger.Trace($"FilmLengthItem(): FilmLengthItem with ID = '{id}' created");
        }

        // --- Methods ---

        /// <summary>
        /// Retrieves the basic information of the film length item from the database.
        /// </summary>
        /// <param name="retrieveBasicInfoOnly">true if only the basic info is to be retrieved; false if also additional data is to be retrieved.</param>
        /// <returns>1 if data record was retrieved; 0 if no data record matched the id.</returns>
        protected override int RetrieveBasicInformation(bool retrieveBasicInfoOnly)
        {
            Logger.Trace($"FilmLengthItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"FilmLengthItem.StatusID is not null -> retrieve");
        ...
        /// <summary>
        /// Retrieves a list of film length items from the database.
        /// </summary>
        /// <param name="reader">The reader to be used to retrieve the data records.</param>
        /// <param name="baseTableName">The base table name of the film length item.</param>
        /// <param name="baseTableID">The base table id of the film length item.</param>
        /// <param name="targetTableName">The target table name of the film length item.</param>
        /// <param name="order">The order in which the data records are to be sorted.</param>
        /// <returns>The list of film length items.</returns>
        /// <exception cref="ArgumentNullException">Thrown when any of the given parameters is null.</exception>
        public static List<FilmLengthItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName, string order = "ID")
        {
            Logger.Trace($"FilmLengthItem.RetrieveList()");
            ...
            if (noOfDataRecords > 0)
            {
                ...
                {
                    FilmLengthItem item = new FilmLengthItem(reader.New());
