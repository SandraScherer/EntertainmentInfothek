...
namespace EntertainmentDB.Data
{
    ...
    public class FilmLengthItem : EntryItem
    {
        ...
        public FilmLengthItem(string id, string targetTableName = "FilmLength")
        {
            if (id == null)
            {
        ...
        public static List<FilmLengthItem> RetrieveList(DBReader reader, string baseTableName, string baseTableID, string targetTableName = "FilmLength", string order = "ID")
        {
            if (reader == null)
            {
