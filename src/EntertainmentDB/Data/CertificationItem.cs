...
namespace EntertainmentDB.Data
{
    ...
    public class CertificationItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a certification item with the given reader and empty id string and table names.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a certification item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the certification item information from the database.</param>
        ...
        {
            Logger.Trace($"CertificationItem(): CertificationItem with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"CertificationItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"CertificationItem.CertificationID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"CertificationItem.StatusID is not null -> retrieve");
        ...
        {
            Logger.Trace($"CertificationItem.RetrieveList()");
