...
namespace EntertainmentDB.Data
{
    ...
    public class LocationItem : EntryItem
    {
        ...
        /// <summary>
        /// Initializes a location item with the given reader and empty id string and table names.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a location item with the given reader, id string and table names.
        /// </summary>
        /// <param name="reader">The database reader to be used to read the location item information from the database.</param>
        ...
        {
            Logger.Trace($"LocationItem(): LocationItem with ID = '{id}' created");
        }
        ...
        {
            Logger.Trace($"LocationItem.RetrieveBasicInformation()");
            ...
            if (noOfDataRecords == 1)
            {
                ...
                {
                    Logger.Debug($"LocationItem.LocationID is not null -> retrieve");
                ...
                {
                    Logger.Debug($"LocationItem.StatusID is not null -> retrieve");
        ...
        {
            Logger.Trace($"LocationItem.RetrieveList()");
