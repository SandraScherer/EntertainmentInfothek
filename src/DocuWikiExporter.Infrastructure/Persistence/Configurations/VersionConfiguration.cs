...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Version".</summary>
public sealed class VersionConfiguration : IEntityTypeConfiguration<Version>
{
    public void Configure(EntityTypeBuilder<Version> builder)
    {
        ...
        builder.Property(x => x.VersionNo).HasColumnName("VersionNo");
        ...
        builder.HasOne(x => x.Platform)
            .WithMany(x => x.VersionByPlatformID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.VersionByStatusID)
