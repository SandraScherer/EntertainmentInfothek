...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Movie_FilmingLocation".</summary>
public sealed class MovieFilmingLocationConfiguration : IEntityTypeConfiguration<MovieFilmingLocation>
{
    public void Configure(EntityTypeBuilder<MovieFilmingLocation> builder)
    {
        ...
        builder.HasOne(x => x.Location)
            .WithMany(x => x.MovieFilmingLocationByLocationID)
        ...
        builder.HasOne(x => x.Movie)
            .WithMany(x => x.MovieFilmingLocationByMovieID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.MovieFilmingLocationByStatusID)
