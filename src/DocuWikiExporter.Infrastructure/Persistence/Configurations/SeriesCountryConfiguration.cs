...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Series_Country".</summary>
public sealed class SeriesCountryConfiguration : IEntityTypeConfiguration<SeriesCountry>
{
    public void Configure(EntityTypeBuilder<SeriesCountry> builder)
    {
        ...
        builder.HasOne(x => x.Country)
            .WithMany(x => x.SeriesCountryByCountryID)
        ...
        builder.HasOne(x => x.Series)
            .WithMany(x => x.SeriesCountryBySeriesID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.SeriesCountryByStatusID)
