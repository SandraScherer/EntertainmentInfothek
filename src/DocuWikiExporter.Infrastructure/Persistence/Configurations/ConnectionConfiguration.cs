...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Connection".</summary>
public sealed class ConnectionConfiguration : IEntityTypeConfiguration<Connection>
{
    public void Configure(EntityTypeBuilder<Connection> builder)
    {
        ...
        builder.HasOne(x => x.Connection)
            .WithMany(x => x.ConnectionByConnectionID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.ConnectionByStatusID)
