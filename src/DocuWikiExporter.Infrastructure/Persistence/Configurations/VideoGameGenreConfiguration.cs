...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "VideoGame_Genre".</summary>
public sealed class VideoGameGenreConfiguration : IEntityTypeConfiguration<VideoGameGenre>
{
    public void Configure(EntityTypeBuilder<VideoGameGenre> builder)
    {
        ...
        builder.HasOne(x => x.Genre)
            .WithMany(x => x.VideoGameGenreByGenreID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.VideoGameGenreByStatusID)
        ...
        builder.HasOne(x => x.VideoGame)
            .WithMany(x => x.VideoGameGenreByVideoGameID)
