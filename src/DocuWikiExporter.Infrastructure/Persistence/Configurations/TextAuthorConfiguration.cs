...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Text_Author".</summary>
public sealed class TextAuthorConfiguration : IEntityTypeConfiguration<TextAuthor>
{
    public void Configure(EntityTypeBuilder<TextAuthor> builder)
    {
        ...
        builder.HasOne(x => x.Person)
            .WithMany(x => x.TextAuthorByPersonID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.TextAuthorByStatusID)
        ...
        builder.HasOne(x => x.Text)
            .WithMany(x => x.TextAuthorByTextID)
