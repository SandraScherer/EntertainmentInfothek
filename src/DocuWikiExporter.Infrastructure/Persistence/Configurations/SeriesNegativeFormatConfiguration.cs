...
/// <summary>Fluent-API-Mapping für die unveränderte SQLite-Tabelle "Series_NegativeFormat".</summary>
public sealed class SeriesNegativeFormatConfiguration : IEntityTypeConfiguration<SeriesNegativeFormat>
{
    public void Configure(EntityTypeBuilder<SeriesNegativeFormat> builder)
    {
        ...
        builder.HasOne(x => x.FilmFormat)
            .WithMany(x => x.SeriesNegativeFormatByFilmFormatID)
        ...
        builder.HasOne(x => x.Series)
            .WithMany(x => x.SeriesNegativeFormatBySeriesID)
        ...
        builder.HasOne(x => x.Status)
            .WithMany(x => x.SeriesNegativeFormatByStatusID)
