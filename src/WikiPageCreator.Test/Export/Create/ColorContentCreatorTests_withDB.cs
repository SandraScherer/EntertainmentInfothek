...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class ColorContentCreatorTests_withDB
    {
        ...
        public void ColorContentCreatorTest_withColorsNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new ColorContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void ColorContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ColorContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void ColorContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ColorContentCreator(list, formatter, null));
        }
        ...
        public void ColorContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ColorContentCreator(list, formatter, ""));
        }
