...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class PrintedFilmFormatContentCreatorTests_withDB
    {
        ...
        public void PrintedFilmFormatContentCreatorTest(string id, string targetLanguageCode)
        {
            ...
            Assert.AreEqual("Printed Film Format", creator.Headings["en"]);
            Assert.AreEqual("Filmformat", creator.Headings["de"]);
        }
        ...
        public void PrintedFilmFormatContentCreatorTest_withPrintedFilmFormatsNull(string targetLanguageCode)
        {
            // Arrange
            Formatter formatter = new DokuWikiFormatter();
            PrintedFilmFormatContentCreator creator;

            // Act, Assert
            Assert.ThrowsException<NullReferenceException>(() => creator = new PrintedFilmFormatContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void PrintedFilmFormatContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new PrintedFilmFormatContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void PrintedFilmFormatContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new PrintedFilmFormatContentCreator(list, formatter, null));
        }
        ...
        public void PrintedFilmFormatContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new PrintedFilmFormatContentCreator(list, formatter, ""));
        }
