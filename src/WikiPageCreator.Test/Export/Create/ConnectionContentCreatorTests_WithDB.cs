...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class ConnectionContentCreatorTests_WithDB
    {
        ...
        public void ConnectionContentCreatorTest_withConnectionNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ConnectionContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void ConnectionContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ConnectionContentCreator(entry, null, targetLanguageCode));
        }
        ...
        public void ConnectionContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ConnectionContentCreator(entry, formatter, null));
        }
        ...
        public void ConnectionContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ConnectionContentCreator(entry, formatter, ""));
        }
        ...
        public void CreateSectionContentTest(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NotSupportedException>(() => content = creator.CreateSectionContent());
        }
    }
}
