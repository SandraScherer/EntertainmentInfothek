...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class CertificationContentCreatorTests_withDB
    {
        ...
        public void CertificationContentCreatorTest_withCertificationsNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new CertificationContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void CertificationContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new CertificationContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void CertificationContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new CertificationContentCreator(list, formatter, null));
        }
        ...
        public void CertificationContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new CertificationContentCreator(list, formatter, ""));
        }
