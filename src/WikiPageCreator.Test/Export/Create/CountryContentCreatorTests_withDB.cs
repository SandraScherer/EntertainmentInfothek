...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class CountryContentCreatorTests_withDB
    {
        ...
        public void CountryContentCreatorTest_withCountriesNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<NullReferenceException>(() => creator = new CountryContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void CountryContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new CountryContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void CountryContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new CountryContentCreator(list, formatter, null));
        }
        ...
        public void CountryContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new CountryContentCreator(list, formatter, ""));
        }
