...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class TimespanContentCreatorTests_withDB
    {
        ...
        public void TimespanContentCreatorTest_withTimespansNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<NullReferenceException>(() => creator = new TimespanContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void TimespanContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new TimespanContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void TimespanContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new TimespanContentCreator(list, formatter, null));
        }
        ...
        public void TimespanContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new TimespanContentCreator(list, formatter, ""));
        }
