...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class TimespanContentCreatorTests_withDB
    {
        ...
        public void TimespanContentCreatorTest_withTimespansNull(string targetLanguageCode)
        {
            // Arrange
            Formatter formatter = new DokuWikiFormatter();
            TimespanContentCreator creator;

            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new TimespanContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void TimespanContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new TimespanContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void TimespanContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new TimespanContentCreator(list, formatter, null));
        }
        ...
        public void TimespanContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new TimespanContentCreator(list, formatter, ""));
        }
        ...
        public void CreateSectionContentTest_withStartDateEmpty(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => content = creator.CreateSectionContent());
        }
    }
}
