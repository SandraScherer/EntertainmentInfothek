...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class ProductionDateContentCreatorTests_withDB
    {
        ...
        public void ProductionDateContentCreatorTest_withProductionDatesNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new ProductionDateContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void ProductionDateContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ProductionDateContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void ProductionDateContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ProductionDateContentCreator(list, formatter, null));
        }
        ...
        public void ProductionDateContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new ProductionDateContentCreator(list, formatter, ""));
        }
