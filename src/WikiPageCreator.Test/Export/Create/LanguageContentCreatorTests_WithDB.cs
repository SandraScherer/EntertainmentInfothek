...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class LanguageContentCreatorTests_withDB
    {
        ...
        public void LanguageContentCreatorTest_withLanguagesNull(string targetLanguageCode)
        {
            // Arrange
            Formatter formatter = new DokuWikiFormatter();
            LanguageContentCreator creator;

            // Act, Assert
            Assert.ThrowsException<NullReferenceException>(() => creator = new LanguageContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void LanguageContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new LanguageContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void LanguageContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new LanguageContentCreator(list, formatter, null));
        }
        ...
        public void LanguageContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsException<ArgumentNullException>(() => creator = new LanguageContentCreator(list, formatter, ""));
        }
