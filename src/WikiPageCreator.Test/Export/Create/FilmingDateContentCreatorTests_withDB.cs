...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class FilmingDateContentCreatorTests_withDB
    {
        ...
        public void FilmingDateContentCreatorTest_withFilmingDatesNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new FilmingDateContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void FilmingDateContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmingDateContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void FilmingDateContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmingDateContentCreator(list, formatter, null));
        }
        ...
        public void FilmingDateContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmingDateContentCreator(list, formatter, ""));
        }
