...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class LaboratoryContentCreatorTests_withDB
    {
        ...
        public void LaboratoryContentCreatorTest_withLaboratoriesNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new LaboratoryContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void LaboratoryContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new LaboratoryContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void LaboratoryContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new LaboratoryContentCreator(list, formatter, null));
        }
        ...
        public void LaboratoryContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new LaboratoryContentCreator(list, formatter, ""));
        }
