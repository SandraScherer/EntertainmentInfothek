...
{
    [TestClass()]
    public class FilmFormatContentCreatorTests_withDB
    {
        ...
        public void FilmFormatContentCreatorTest(string id, string targetLanguageCode)
        {
            // Arrange
        ...
        [DataRow("de")]
        [DataRow("zz")]
        public void FilmFormatContentCreatorTest_withFilmFormatsNull(string targetLanguageCode)
        {
            // Arrange
            Formatter formatter = new DokuWikiFormatter();
            FilmFormatContentCreator creator;

            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new FilmFormatContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        [DataRow(INVALID_ID, "de")]
        [DataRow(INVALID_ID, "zz")]
        public void FilmFormatContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            FilmFormat entry = new FilmFormat(reader, id);
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmFormatContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void FilmFormatContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmFormatContentCreator(list, formatter, null));
        }
        ...
        public void FilmFormatContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new FilmFormatContentCreator(list, formatter, ""));
        }
