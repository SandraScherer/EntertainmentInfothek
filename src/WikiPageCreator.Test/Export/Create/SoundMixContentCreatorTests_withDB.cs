...
namespace WikiPageCreator.Export.Create.IntegrationTests
{
    ...
    public class SoundMixContentCreatorTests_withDB
    {
        ...
        public void SoundMixContentCreatorTest_withSoundMixesNull(string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<NullReferenceException>(() => creator = new SoundMixContentCreator(null, formatter, targetLanguageCode));
        }
        ...
        public void SoundMixContentCreatorTest_withFormatterNull(string id, string targetLanguageCode)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new SoundMixContentCreator(list, null, targetLanguageCode));
        }
        ...
        public void SoundMixContentCreatorTest_withTargetLanguageCodeNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new SoundMixContentCreator(list, formatter, null));
        }
        ...
        public void SoundMixContentCreatorTest_withTargetLanguageCodeEmptyString(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => creator = new SoundMixContentCreator(list, formatter, ""));
        }
