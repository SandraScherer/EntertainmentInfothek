...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class CertificationItemTests
    {
        ...
        [DataTestMethod()]
        [DataRow("Movie")]
        public void RetrieveBasicInformationTest_withInvalidID_Additional(string value)
        {
            // Arrange
            CertificationItem item = new CertificationItem("_aa1", "Certification");
            item.BaseTableName = value;
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            // Act
            List<CertificationItem> list = Data.CertificationItem.RetrieveList(reader, value, "_xxx", "Certification");
            ...
            Assert.AreEqual($"{value} Certification LastUpdated X1", list[0].LastUpdated);
            ...
            Assert.AreEqual($"{value} Certification LastUpdated X2", list[1].LastUpdated);
            ...
            Assert.AreEqual($"{value} Certification LastUpdated X3", list[2].LastUpdated);
        }
    }
}
