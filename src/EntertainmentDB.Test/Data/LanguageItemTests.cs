...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class LanguageItemTests
    {
        ...
        {
            // Arrange
            LanguageItem item = new LanguageItem("_xx1", "Language");
        ...
        public void RetrieveBasicInformationTest_withValidID_BasicInfoOnly(string value)
        {
            ...
            Assert.AreEqual($"{value} Language LastUpdated X1", item.LastUpdated);
        }
        ...
        {
            // Arrange
            LanguageItem item = new LanguageItem("_aa1", "Language");
            item.BaseTableName = value;
