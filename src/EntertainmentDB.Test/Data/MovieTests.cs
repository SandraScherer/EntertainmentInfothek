...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class MovieTests
    {
        ...
        public void RetrieveBasicInformationTest_withValidID_BasicInfoOnly()
        {
            ...
            Assert.AreEqual("_xxx", entry.ID);
            Assert.AreEqual("Movie OriginalTitle X", entry.OriginalTitle);
            Assert.AreEqual("Movie EnglishTitle X", entry.EnglishTitle);
            Assert.AreEqual("Movie GermanTitle X", entry.GermanTitle);
            Assert.AreEqual("_xxx", entry.Type.ID);
            Assert.AreEqual("Movie ReleaseDate X", entry.ReleaseDate);
            Assert.AreEqual("_xxx", entry.Logo.ID);
            Assert.AreEqual("Movie Budget X", entry.Budget);
            Assert.AreEqual("Movie WorldwideGross X", entry.WorldwideGross);
            Assert.AreEqual("Movie WorldwideGrossDate X", entry.WorldwideGrossDate);
            ...
            Assert.AreEqual("Movie LastUpdated X", entry.LastUpdated);
        ...
        public void RetrieveTest_withInvalidID_AdditionalInfo()
        {
            ...
            Assert.AreEqual(0, entry.Genres.Count);
            Assert.AreEqual(0, entry.Certifications.Count);
            Assert.AreEqual(0, entry.Countries.Count);
            Assert.AreEqual(0, entry.Languages.Count);
            Assert.AreEqual(0, entry.Runtimes.Count);
            Assert.AreEqual(0, entry.SoundMixes.Count);
            Assert.AreEqual(0, entry.Colors.Count);
            Assert.AreEqual(0, entry.AspectRatios.Count);
            Assert.AreEqual(0, entry.Cameras.Count);
            Assert.AreEqual(0, entry.Laboratories.Count);
            Assert.AreEqual(0, entry.FilmLengths.Count);
            Assert.AreEqual(0, entry.NegativeFormats.Count);
            Assert.AreEqual(0, entry.CinematographicProcesses.Count);
            Assert.AreEqual(0, entry.PrintedFilmFormats.Count);

            Assert.AreEqual(0, entry.Directors.Count);
            Assert.AreEqual(0, entry.Writers.Count);
            Assert.AreEqual(0, entry.Cast.Count);
            Assert.AreEqual(0, entry.Producers.Count);
            Assert.AreEqual(0, entry.Music.Count);
            Assert.AreEqual(0, entry.Cinematography.Count);
            Assert.AreEqual(0, entry.FilmEditing.Count);
            Assert.AreEqual(0, entry.Casting.Count);
            Assert.AreEqual(0, entry.ProductionDesign.Count);
            Assert.AreEqual(0, entry.ArtDirection.Count);
            Assert.AreEqual(0, entry.SetDecoration.Count);
            Assert.AreEqual(0, entry.CostumeDesign.Count);
            Assert.AreEqual(0, entry.MakeupDepartment.Count);
            Assert.AreEqual(0, entry.ProductionManagement.Count);
            Assert.AreEqual(0, entry.AssistantDirectors.Count);
            Assert.AreEqual(0, entry.ArtDepartment.Count);
            Assert.AreEqual(0, entry.SoundDepartment.Count);
            Assert.AreEqual(0, entry.SpecialEffects.Count);
            Assert.AreEqual(0, entry.VisualEffects.Count);
            Assert.AreEqual(0, entry.Stunts.Count);
            Assert.AreEqual(0, entry.ElectricalDepartment.Count);
            Assert.AreEqual(0, entry.AnimationDepartment.Count);
            Assert.AreEqual(0, entry.CastingDepartment.Count);
            Assert.AreEqual(0, entry.CostumeDepartment.Count);
            Assert.AreEqual(0, entry.EditorialDepartment.Count);
            Assert.AreEqual(0, entry.LocationManagement.Count);
            Assert.AreEqual(0, entry.MusicDepartment.Count);
            Assert.AreEqual(0, entry.ContinuityDepartment.Count);
            Assert.AreEqual(0, entry.TransportationDepartment.Count);
            Assert.AreEqual(0, entry.OtherCrew.Count);

            Assert.AreEqual(0, entry.ProductionCompanies.Count);
            Assert.AreEqual(0, entry.Distributors.Count);
            Assert.AreEqual(0, entry.SpecialEffectsCompanies.Count);
            Assert.AreEqual(0, entry.OtherCompanies.Count);

            Assert.AreEqual(0, entry.FilmingLocations.Count);
            Assert.AreEqual(0, entry.FilmingDates.Count);
            Assert.AreEqual(0, entry.ProductionDates.Count);

            Assert.AreEqual(0, entry.Posters.Count);
            Assert.AreEqual(0, entry.Covers.Count);
            Assert.AreEqual(0, entry.Images.Count);

            Assert.AreEqual(0, entry.Descriptions.Count);
            Assert.AreEqual(0, entry.Reviews.Count);

            Assert.AreEqual(0, entry.Awards.Count);
            Assert.AreEqual(0, entry.Weblinks.Count);
        }
