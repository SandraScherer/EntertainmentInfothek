...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class AwardItemTests_WithDB
    {
        ...
        [DataTestMethod()]
        [DataRow("Movie")]
        public void RetrieveAdditionalInformationTest_withValidID(string baseTableName)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            AwardItem item = new AwardItem(reader, VALID_ID, baseTableName, "Award");
        ...
        [DataTestMethod()]
        [DataRow("Movie")]
        public void RetrieveAdditionalInformationTest_withInvalidID(string baseTableName)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            AwardItem item = new AwardItem(reader, INVALID_ID, baseTableName, "Award");
