...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class WeblinkItemTests
    {
        ...
        public void RetrieveBasicInformationTest_withValidID_BasicInfoOnly(string value)
        {
            ...
            Assert.AreEqual($"{value} Weblink LastUpdated X1", item.LastUpdated);
        }
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            Assert.AreEqual($"{value} Weblink LastUpdated X1", list[0].LastUpdated);
            ...
            Assert.AreEqual($"{value} Weblink LastUpdated X2", list[1].LastUpdated);
            ...
            Assert.AreEqual($"{value} Weblink LastUpdated X3", list[2].LastUpdated);
        }
    }
}
