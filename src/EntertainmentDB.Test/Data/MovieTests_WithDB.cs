...
{
    [TestClass()]
    public class MovieTests_WithDB
    {
        ...
        [DataRow(VALID_ID)]
        [DataRow(INVALID_ID)]
        public void MovieTest_withID(string id)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
        ...
        public void MovieTest_withReaderNull(string id)
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => entry = new Movie(null, id));
        }
        ...
        public void MovieTest_withIDNull()
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => entry = new Movie(reader, null));
        }
        ...
        public void RetrieveTest_withInvalidID(bool basicInfoOnly)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Movie entry = new Movie(reader, INVALID_ID);
        ...
        public void RetrieveListTest_withValidData()
        {
            ...
            // Act
            List<Article> list = Movie.RetrieveList(reader, "_xxx");
        ...
        public void RetrieveListTest_withReaderNull()
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => list = Movie.RetrieveList(null, "_xxx"));
        }
        ...
        public void RetrieveListTest_withStatusNull()
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => list = Movie.RetrieveList(reader, null));
        }
        ...
        public void RetrieveListTest_withOrderNull()
        {
            ...
            // Act, Assert
            Assert.ThrowsExactly<ArgumentNullException>(() => list = Movie.RetrieveList(reader, "_xxx", null));
        }
    }
}
