...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class LaboratoryItemTests
    {
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            // Act
            List<LaboratoryItem> list = Data.LaboratoryItem.RetrieveList(reader, value, "_xxx", "Laboratory");
            ...
            Assert.AreEqual($"{value} Laboratory LastUpdated X1", list[0].LastUpdated);
            ...
            Assert.AreEqual($"{value} Laboratory LastUpdated X2", list[1].LastUpdated);
            ...
            Assert.AreEqual($"{value} Laboratory LastUpdated X3", list[2].LastUpdated);
        }
    }
}
