...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class ImageTests_WithDB
    {
        ...
        public void ImageTest_withID(string id)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Image entry = new Image(reader, id);
        ...
        {
            // Arrange, Act, Assert
            Image entry = new Image(null, id);
        }

        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void ImageTest_withIDNull()
        {
            // Arrange, Act, Assert
            DBReader reader = new SQLiteReader();
            Image entry = new Image(reader, null);
        }
        ...
        public void RetrieveTest_withValidID_BasicInfoOnly()
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Image entry = new Image(reader, VALID_ID);
