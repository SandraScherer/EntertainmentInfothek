...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class LanguageTests_WithDB
    {
        ...
        public void LanguageTest()
        {
            ...
            Language entry = new Language(reader);
        ...
        {
            // Arrange, Act, Assert
            Language entry = new Language(null, id);
        }

        [TestMethod()]
        [ExpectedException(typeof(ArgumentNullException))]
        public void LanguageTest_withIDNull()
        {
            // Arrange, Act, Assert
            DBReader reader = new SQLiteReader();
            Language entry = new Language(reader, null);
        }
        ...
        public void RetrieveTest_withInvalidID(bool basicInfoOnly)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Language entry = new Language(reader, INVALID_ID);
