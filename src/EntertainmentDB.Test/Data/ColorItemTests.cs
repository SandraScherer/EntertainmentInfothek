...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class ColorItemTests
    {
        ...
        public void RetrieveBasicInformationTest_withValidID_BasicInfoOnly(string value)
        {
            ...
            Assert.AreEqual($"{value} Color LastUpdated X1", item.LastUpdated);
        }
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            Assert.AreEqual($"{value} Color LastUpdated X1", list[0].LastUpdated);
            ...
            Assert.AreEqual($"{value} Color LastUpdated X2", list[1].LastUpdated);
            ...
            Assert.AreEqual($"{value} Color LastUpdated X3", list[2].LastUpdated);
        }
    }
}
