...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class CinematographicProcessItemTests
    {
        ...
        {
            // Arrange
            CinematographicProcessItem item = new CinematographicProcessItem("_xx1");
        ...
        {
            // Arrange
            CinematographicProcessItem item = new CinematographicProcessItem("_aa1");
            item.BaseTableName = value;
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            // Act
            List<CinematographicProcessItem> list = Data.CinematographicProcessItem.RetrieveList(reader, value, "_xxx");
