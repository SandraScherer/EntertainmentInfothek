...
{
    [TestClass()]
    public class WeblinkTests_WithDB
    {
        ...
        public void WeblinkTest()
        {
            ...
            Weblink entry = new Weblink(reader);
        ...
        public void WeblinkTest_withID(string id)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Weblink entry = new Weblink(reader, id);
        ...
        public void RetrieveTest_withValidID(bool basicInfoOnly)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Weblink entry = new Weblink(reader, VALID_ID);
        ...
        public void RetrieveTest_withInvalidID(bool basicInfoOnly)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            Weblink entry = new Weblink(reader, INVALID_ID);
