...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class LocationItemTests
    {
        ...
        public void LocationItemTest()
        {
            ...
            Assert.AreEqual("FilmingLocation", item.TargetTableName);
        ...
        [TestMethod()]
        public void LocationItemTest_withID()
        {
            // Arrange
            LocationItem item = new LocationItem("_xx1");
        ...
        {
            // Arrange
            LocationItem item = new LocationItem("_aa1");
            item.BaseTableName = value;
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            // Act
            List<LocationItem> list = Data.LocationItem.RetrieveList(reader, value, "_xxx");
