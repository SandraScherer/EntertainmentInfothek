...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class FilmFormatTests_withDB
    {
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkEntry()
        {
            // Arrange
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkReader()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkFormat()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkDetails()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkStatus()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_checkLastUpdated()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        // oblsolete
        [TestMethod()]
        public void FilmFormatTest_withoutID_checkID()
        {
            // Arrange
            FilmFormat entry = new FilmFormat();
        ...
        [DataRow(VALID_ID)]
        [DataRow(INVALID_ID)]
        public void FilmFormatTest_withID_checkID(string value)
        {
            // Arrange
            FilmFormat entry = new FilmFormat(value);
        ...
        public void FilmFormatTest_withIDnull_checkException()
        {
            // Arrange, Act, Assert
            FilmFormat entry = new FilmFormat(null);
        }
        ...
        {
            // Arrange
            FilmFormat entry = new FilmFormat(VALID_ID);
        ...
        {
            // Arrange
            FilmFormat entry = new FilmFormat(INVALID_ID);
        ...
        [DataRow(true)]
        [DataRow(false)]
        public void RetrieveTest_withValidID_checkFormat(bool value)
        {
            // Arrange
            FilmFormat entry = new FilmFormat(VALID_ID);
        ...
        [DataRow(true)]
        [DataRow(false)]
        public void RetrieveTest_withInvalidID_checkFormat(bool value)
        {
            // Arrange
            FilmFormat entry = new FilmFormat(INVALID_ID);
