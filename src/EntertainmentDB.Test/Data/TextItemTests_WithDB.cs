...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class TextItemTests_WithDB
    {
        ...
        {
            // Arrange, Act, Assert
            TextItem item = new TextItem(null, id, "BaseTable", "TargetTable");
        }
        ...
        public void TextItemTest_withIDNull()
        {
            // Arrange, Act, Assert
            DBReader reader = new SQLiteReader();
            TextItem item = new TextItem(reader, null, "BaseTable", "TargetTable");
        }
        ...
        public void TextItemTest_withBaseTableNameNull(string id)
        {
            // Arrange, Act, Assert
            DBReader reader = new SQLiteReader();
            TextItem item = new TextItem(reader, id, null, "TargetTable");
        }
        ...
        public void TextItemTest_withTargetTableNameNull(string id)
        {
            // Arrange, Act, Assert
            DBReader reader = new SQLiteReader();
            TextItem item = new TextItem(reader, id, "BaseTable", null);
        }
        ...
        [DataTestMethod()]
        [DataRow("Movie", "Description", VALID_ID)]
        [DataRow("Movie", "Description", INVALID_ID)]
        [DataRow("Movie", "Review", VALID_ID)]
        [DataRow("Movie", "Review", INVALID_ID)]
        public void RetrieveAdditionalInformationTest(string baseTableName, string targetTableName, string id)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            TextItem item = new TextItem(reader, id, baseTableName, targetTableName);
