...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class CameraItemTests
    {
        ...
        public void RetrieveListTest_withValidData(string value)
        {
            ...
            Assert.AreEqual($"{value} Camera LastUpdated X1", list[0].LastUpdated);
            ...
            Assert.AreEqual($"{value} Camera LastUpdated X2", list[1].LastUpdated);
            ...
            Assert.AreEqual($"{value} Camera LastUpdated X3", list[2].LastUpdated);
        }
    }
}
