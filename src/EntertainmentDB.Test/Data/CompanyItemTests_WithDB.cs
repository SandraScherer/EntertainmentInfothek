...
namespace EntertainmentDB.Data.Tests
{
    ...
    public class CompanyItemTests_WithDB
    {
        ...
        [DataTestMethod()]
        [DataRow("Image", "Source", VALID_ID)]
        [DataRow("Image", "Source", INVALID_ID)]
        [DataRow("Movie", "ProductionCompany", VALID_ID)]
        [DataRow("Movie", "ProductionCompany", INVALID_ID)]
        [DataRow("Movie", "SpecialEffectsCompany", VALID_ID)]
        [DataRow("Movie", "SpecialEffectsCompany", INVALID_ID)]
        [DataRow("Movie", "OtherCompany", VALID_ID)]
        [DataRow("Movie", "OtherCompany", INVALID_ID)]
        public void RetrieveAdditionalInformationTest(string baseTableName, string targetTableName, string id)
        {
            // Arrange
            DBReader reader = new SQLiteReader();
            CompanyItem item = new CompanyItem(reader, id, baseTableName, targetTableName);
