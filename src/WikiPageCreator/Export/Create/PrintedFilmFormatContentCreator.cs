...
{
    /// <summary>
    /// Provides a content creator for a printed film format.
    /// </summary>
    public class PrintedFilmFormatContentCreator : FilmFormatContentCreator
    {
        // --- Properties ---
            ...
            : base(filmFormats, formatter, targetLanguageCode)
        {
            ...
            Logger.Trace($"PrintedFilmFormatContentCreator(): PrintedFilmFormatContentCreator created");
        }
    }
}
