...
namespace WikiPageCreator.Export.Create
{
    ...
    /// </summary>
    public class FilmingDateContentCreator : TimespanContentCreator
    {
        // --- Properties ---
        ...
        public FilmingDateContentCreator(List<TimespanItem> timespans, Formatter formatter, string targetLanguageCode)
