...
{
    /// <summary>
    /// Provides an interface for a chapter content creator.
    /// </summary>
    public interface IChapterContentCreatable
    {
        /// <summary>
        ...
        List<string> CreateChapterContent(Entry entry, string targetLanguageCode, Formatter formatter);
    }
}
