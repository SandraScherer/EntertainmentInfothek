...
CREATE TABLE Series_NegativeFormat (
  ...
  FOREIGN KEY(FilmFormatID) REFERENCES FilmFormat(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_PrintedFilmFormat (
  ID            text NOT NULL, 
  SeriesID      text, 
  FilmFormatID  text, 
  Details       text, 
  ...
  FOREIGN KEY(FilmFormatID) REFERENCES FilmFormat(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_CinematographicProcess (
  ID                       text NOT NULL, 
  SeriesID                 text, 
  CinematographicProcessID text, 
  Details                  text, 
...
CREATE TABLE Series_FilmingLocation (
  ...
  FOREIGN KEY(LocationID) REFERENCES Location(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_ProductionCompany (
  ID          text NOT NULL, 
  SeriesID    text, 
  CompanyID   text, 
  Role        text, 
  ...
  FOREIGN KEY(CompanyID) REFERENCES Company(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_Distributor (
  ID          text NOT NULL, 
  SeriesID    text, 
  CompanyID   text, 
  CountryID   text, 
  ...
  FOREIGN KEY(CountryID) REFERENCES Country(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_SpecialEffectsCompany (
  ID          text NOT NULL, 
  SeriesID    text, 
  CompanyID   text, 
  Role        text, 
  ...
  FOREIGN KEY(CompanyID) REFERENCES Company(ID) ON UPDATE No action ON DELETE No action, 
  FOREIGN KEY(StatusID) REFERENCES Status(ID) ON UPDATE No action ON DELETE No action);
CREATE TABLE Series_OtherCompany (
  ID          text NOT NULL, 
  SeriesID    text, 
  CompanyID   text, 
  Role        text, 
